    ...
    const faqs = [
        {
            ...
            "answer": `${import.meta.env.VITE_APP_NAME} is a Shopify app that allows you to define and calculate custom delivery charges for your store's checkout process based on specific rules you set.`
        },
        {
